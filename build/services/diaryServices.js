...
exports.addDiary = exports.getEntriesWithoutSensitiveInfo = exports.findNonSensitiveInfoDiaryById = exports.findDiaryById = exports.getDiaries = void 0;
...
exports.findDiaryById = findDiaryById;
const findNonSensitiveInfoDiaryById = (id) => {
    const entry = diaries.find(d => d.id === id);
    if (entry != null) {
...
exports.findNonSensitiveInfoDiaryById = findNonSensitiveInfoDiaryById;
